...
import { Link } from 'react-router-dom';
 ...
 export function UsuarioInt_inicio() {
     return(
         <>
         <body>
         <link rel="stylesheet" href="css/UI_INICIO.css"/>
                        ...
                        <div className="collapse navbar-collapse" id="POSICION_DIV_HEADER">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0" id="headertxt">
                                <li className="nav-item">
                                    <a href="/UI_inicio" className="nav-link active" aria-current="page"  id="headertxt">INCIO</a>
                                </li>
            ...
            <section>
                <article>
                    <a class="nav-link" href="/UI_Examenes" id="headertxt">Crear y gestionar los<br/> tipos de exámenes</a>
                </article>
                <article>
                    <a class="nav-link" href="/UI_Agenda" id="headertxt">Crear y gestionar la <br/>agenda para la toma de muestras</a>        
                </article>   
                <article>
                    <a class="nav-link" href="/UI_ModAgenda" id="headertxt">Cancelar o modificar el <br/>agendamiento</a>        
                </article>
                <article>
                    <a class="nav-link" href="/UI_Resultados" id="headertxt">Ingresar resultados de la<br/> muestra</a>        
                </article>
                <article>
                    <a class="nav-link" href="/UI_Notificar" id="headertxt">Notificar al usuario la <br/>disponibilidad</a>        
                </article>                           
            </section>
     <aside>
