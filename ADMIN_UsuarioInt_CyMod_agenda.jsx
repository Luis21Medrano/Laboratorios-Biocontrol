...
export function ADMIN_UsuarioInt_CyMod_agenda() {
    return(
        <>
         <link rel="stylesheet" href="css/ADMIN-UsuarioInt_inicio.css"/>
         <link rel="stylesheet" href="css/UI_CyMod_agenda.css"/>
                        ...
                        <div className="collapse navbar-collapse" id="POSICION_DIV_HEADER">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0" id="headertxt">
                                <li className="nav-item">
                                    <a href="/A_UI_Modagenda" className="nav-link active" aria-current="page"  id="headertxt">AGENDA</a>
                                </li>
                      ...
                      <form method="POST" id="signup-form" className="signup-form-ag">
                          <div className="form-row">
                              ...
                              <div className="form-group">
                                ...
                                <input type="submit" name="submit" id="BU-ID" className="form-submit" value="BUSCAR"/>
                              </div>
                          </div>
                            <div className="form-row">
                            <div className="form-group">
                        ...
                        <div className="form-row">
                          <div className="form-group">
                            <input type="submit" name="submit" id="BU-MODAL_BUSCAR" className="form-submit" value="CANCELAR" />
                        </div>
                          <div>
                            <input type="button" className="form-submit" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="listar()" value="MOSTRAR AGENDA" id="BU-MODAL"/>
